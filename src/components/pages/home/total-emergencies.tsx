  ...
  return (
    <div className={cn("flex flex-col p-6 gap-[3.125rem] rounded-2xl bg-[#FFEEEE]", className)}>
      <div className="flex items-start justify-between">
        ...
        <Button className="bg-semantics-red text-white px-2 py-2.5 rounded-lg">
          <span className="hidden lg:flex font-medium">View Emergencies</span>
          <Icon icon="radix-icons:arrow-top-right" className="size-5" />
        </Button>
      </div>
      <LineChart
        data={data}
          ...
          return (
            <div className="relative bg-grey-dark-1 p-2 flex flex-col gap-1.5 rounded text-white">
              <div className="flex items-center gap-1">
                <div className="bg-semantics-red size-1.5 rounded" />
