...
export const ChangePasswordSuccessPage: React.FC = () => {
    return (
        <motion.div variants={routeVariants} initial='initial' animate='final' exit={routeVariants.initial} className="grid gap-8 p-7 lg:p-8 bg-white max-w-md w-full h-fit place-self-center rounded-xl">
